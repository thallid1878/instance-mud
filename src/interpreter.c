...
cpp_extern const struct command_info cmd_info[] = {
  ...
  /* now, the main list */
  { "addexp"   , "addexp"  , POS_DEAD    , do_addexp   , LVL_IMMORT, 0 },
  ...
  { "buystat"  , "buystat" , POS_RESTING , do_buystat  , 0, 0 },
  ...
  { "combatinfo", "combatinfo", POS_DEAD  , do_combatinfo, LVL_IMMORT, 0 },
  ...
  { "instance" , "instance", POS_STANDING, do_instance , LVL_IMPL, 0 },
  ...
  { "sqlexport", "sqlexport", POS_DEAD   , do_sqlexport, LVL_IMPL, 0 },
