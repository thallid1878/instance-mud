...
static variable_name_t VariableNameTable[eMSDP_MAX+1] = 
{
   ...
   { eMSDP_OPPONENT_MANA,    "OPPONENT_MANA",    NUMBER_READ_ONLY },
   { eMSDP_OPPONENT_MANA_MAX,"OPPONENT_MANA_MAX",NUMBER_READ_ONLY },
   { eMSDP_OPPONENT_MOVEMENT,"OPPONENT_MOVEMENT",NUMBER_READ_ONLY },
   { eMSDP_OPPONENT_MOVEMENT_MAX,"OPPONENT_MOVEMENT_MAX",NUMBER_READ_ONLY },
