...
#define SHOP_AT(i)		(shop_by_rnum((i)))
#define SHOP_NUM(i)		(SHOP_AT(i)->vnum)
#define SHOP_KEEPER(i)		(SHOP_AT(i)->keeper)
#define SHOP_OPEN1(i)		(SHOP_AT(i)->open1)
#define SHOP_CLOSE1(i)		(SHOP_AT(i)->close1)
#define SHOP_OPEN2(i)		(SHOP_AT(i)->open2)
#define SHOP_CLOSE2(i)		(SHOP_AT(i)->close2)
#define SHOP_ROOM(i, num)	(SHOP_AT(i)->in_room[(num)])
#define SHOP_BUYTYPE(i, num)	(BUY_TYPE(SHOP_AT(i)->type[(num)]))
#define SHOP_BUYWORD(i, num)	(BUY_WORD(SHOP_AT(i)->type[(num)]))
#define SHOP_PRODUCT(i, num)	(SHOP_AT(i)->producing[(num)])
#define SHOP_BANK(i)		(SHOP_AT(i)->bankAccount)
#define SHOP_BROKE_TEMPER(i)	(SHOP_AT(i)->temper1)
#define SHOP_BITVECTOR(i)	(SHOP_AT(i)->bitvector)
#define SHOP_TRADE_WITH(i)	(SHOP_AT(i)->with_who)
#define SHOP_SORT(i)		(SHOP_AT(i)->lastsort)
#define SHOP_BUYPROFIT(i)	(SHOP_AT(i)->profit_buy)
#define SHOP_SELLPROFIT(i)	(SHOP_AT(i)->profit_sell)
#define SHOP_FUNC(i)		(SHOP_AT(i)->func)
